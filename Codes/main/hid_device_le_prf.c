...
uint16_t battary_lev_handle_table[BAS_IDX_NB];

uint8_t battary_lev = 100;
    ...
    switch(event) {
        ...
        case ESP_GATTS_CREAT_ATTR_TAB_EVT: {
            if (param->add_attr_tab.num_handle == BAS_IDX_NB &&
                ...
                memcpy(battary_lev_handle_table, param->add_attr_tab.handles, sizeof(battary_lev_handle_table));
